...
- [Введение](#vvedenie)
- [Разница между Cron, Crontab и Cron Job](#raznica-mejdu-cron-crontab-cronjob)
  - [Cron](#cron)
  - [Crontab](#crontab)
  - [Cron Job](#cron-job)
- [Crontab: Синтаксис](#crontab-syntax)
- [Практические примеры](#practicheskie-primery)
  - [Пример 1: Запуск сценария каждый час](#primer-1-zapusk-scenariya-kazhdyj-chas)
  - [Пример 2: Запуск сценария каждый день в определённое время](#primer-2-zapusk-scenariya-kazhdyj-den-v-opredelennoe-vremya)
  - [Пример 3: Запуск сценария в определённые дни недели](#primer-3-zapusk-scenariya-v-opredelennye-dni-nedeli)
  - [Пример 4: Запуск сценария каждый месяц](#primer-4-zapusk-scenariya-kazhdyj-mesyats)
  - [Пример 5: Запуск сценария с регулярными интервалами](#primer-5-zapusk-scenariya-s-regulyarnymi-intervalami)
- [Вывод](#vyvod)
- [Ссылки на источники](#ssylki-na-istochniki)
