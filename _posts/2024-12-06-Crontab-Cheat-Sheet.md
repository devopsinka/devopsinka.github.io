...
- [Практические примеры](#практические-примеры)
  ...
  - [Пример 2: Запуск сценария каждый день в определенное время](#пример-2-запуск-сценария-каждый-день-в-определенное-время)
  - [Пример 3: Запуск сценария в определенные дни недели](#пример-3-запуск-сценария-в-определенные-дни-недели)
  - [Пример 4: Запуск сценария каждый месяц](#пример-4-запуск-сценария-каждый-месяц)
  - [Пример 5: Запуск сценария сценария регулярными интервалами](#пример-5-запуск-сценария-с-регулярными-интервалами)
